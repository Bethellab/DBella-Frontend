...
const SignUp = () => {
    return (
        <div
            ...
            className="h-screen bg-cover bg-center overflow-hidden flex justify-center items-center"
        >
            <div className="w-full px-4 sm:px-8 md:px-16">

                <div className="w-full max-w-[700px] bg-white rounded-lg p-6 sm:p-8 md:p-10 relative overflow-hidden shadow-md my-24 mx-auto">
                    {/* Header Section */}
                    <div className="text-center mt-10 space-y-4">
                        <h1 className="text-4xl font-bold text-[#191515]">
                            Sign up As a Client
                        </h1>
                        <p className="text-lg font-normal text-[#404245]">
                            Kindly fill this short form to get you started...
                        </p>
                    </div>

                    {/* Input Section */}
                    <div className="flex flex-col gap-8 mt-6 mx-4 sm:mx-8 md:mx-10">
                        {/* Full Name Input */}
                        ...
                        {/* Register Button */}
                        <button className="w-full h-[44px] bg-[#5e25cc] text-white text-sm font-semibold rounded-full mt-8 hover:bg-[#4d1eaa] transition">
                            Register
                        </button>
