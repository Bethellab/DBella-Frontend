...
const Footer = () => {
    return (
        <div>
            <div className=" w-full main-container max-w-[1500px] h-[500px] bg-white relative mx-auto">
                <div className="absolute top-[115px] left-[566px] right-[120px]">
                    <div className="flex w-[736px] gap-20">
                        {/* Quick Links Section */}
                ...
                <div className="absolute top-[120px] left-20">
                    <img src={logo} className="w-20 h-20 " /> {/* Placeholder for Logo */}
                    <span className="block mt-6 text-sm text-gray-600 w-[400px]">
