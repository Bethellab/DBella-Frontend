...
const Relax = () => {
    return (
        <>
            ...
            <div className=" w-full h-[1234px] bg-[#f8f5ff] relative my-0 block lg:hidden overflow-hidden">
                <img src={relax1} className="w-[124px] h-[205px] bg-cover bg-no-repeat rounded-[150px] absolute top-[64px] left-[106px]" />
                <img src={relax2} className="w-[72px] h-[120px]  bg-cover bg-no-repeat rounded-[150px] absolute top-[149px] left-[24px] z-[3]" />
                <span className="flex h-[194px] justify-start items-center font-['Cormorant_Garamond'] text-[160px] font-bold opacity-10 leading-[193.76px] text-[#5e25cc] tracking-[1.6px] absolute top-[200px] left-[24px] text-left whitespace-nowrap z-[6]">
                    relax
                </span>
                <span className="flex w-[372px] h-[68px] justify-start items-start font-['Cormorant_Garamond'] text-[32px] font-bold leading-[34px] text-[#191515] tracking-[0.32px] absolute top-[323px] left-[24px] text-left z-10">
                    Immerse yourself in a calming environment.
                </span>
                <img src={revitate1} className="w-[124px] h-[205px]  bg-cover bg-no-repeat rounded-[150px] absolute top-[455px] left-[198px] z-[2]" />
                <img src={revitate2} className="w-[72px] h-[120px]  bg-cover bg-no-repeat rounded-[150px] absolute top-[540px] left-[332px] z-[5]" />
                ...
                <span className="flex w-[372px] h-[68px] justify-end  items-start font-['Cormorant_Garamond'] text-[32px] font-bold leading-[34px] text-[#191515] tracking-[0.32px] absolute top-[711px]  text-right z-[9]">
                    Experience transformative care for mind and body.
                </span>
                <img src={rediscover1} className="w-[124px] h-[205px]  bg-cover bg-no-repeat rounded-[150px] absolute top-[843px] left-[106px] z-[1]" />
                <img src={rediscover2} className="w-[72px] h-[120px]  bg-cover bg-no-repeat rounded-[150px] absolute top-[928px] left-[24px] z-[4]" />
                ...
                <span className="flex w-[372px] h-[68px] justify-start items-start font-['Cormorant_Garamond'] text-[32px] font-bold leading-[34px] text-[#191515] tracking-[0.32px] absolute top-[1102px] left-[24px] text-left z-[11]">
                    Uncover a renewed sense of confidence and beauty.
                </span>
            </div>
