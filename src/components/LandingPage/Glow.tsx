    ...
    return (
        <div>
            <div className="flex flex-col justify-between items-center bg-[#5e25cc] relative w-full h-[500px] px-6 py-12 sm:px-12 md:px-24 lg:px-32">
                {/* Testimonial Content */}
                <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 items-center w-full text-center mt-24">
                    <span className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold leading-tight text-white lg:w-[1200px] px-4">
