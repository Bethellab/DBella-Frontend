...
const Services = () => {
    return (
        <div className="py-12 lg:mx-24 mx-4">
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
                    <div
                        ...
                        className="flex w-full h-[250px] md:h-[302px] items-center bg-cover bg-no-repeat rounded-md"
                    >
                        <div className="flex p-6 md:p-[50px] justify-center items-center bg-gray-100 rounded-md mx-auto">
                            <span className="text-sm md:text-[16px] font-semibold text-[#120728] text-center">
                                HAIR STYLING <br /> & TREATMENT
                            </span>
                        </div>
                    </div>
